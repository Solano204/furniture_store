...
```bash
DATABASE_URL="postgresql://postgres.aqdgpxrvyszgdtavfbzy:76i765i8@aws-0-us-west-1.pooler.supabase.com:6543/postgres?pgbouncer=true&connection_limit=1"
DIRECT_URL="postgresql://postgres.aqdgpxrvyszgdtavfbzy:76i765i8@aws-0-us-west-1.pooler.supabase.com:5432/postgres"
```
...
```sh
ADMIN_USER_ID=user_2raoMi727Rf03n2DqZEc7uZjLhb
```
